...
const
  ...
  kSQLCreateTableMainposition = 'CREATE TABLE ' + kSQLTableClients + ' (' +
...
procedure TClientIDBook.CloseDatabase;
begin
...
constructor TClientIDBook.Create;
var
  ForTesting: Integer;
...
destructor TClientIDBook.Destroy;
var
  TESTName: String;
...
function TClientIDBook.CreateDatabase(aFileName: String): Boolean;
var
...
function TClientIDBook.GetPragma(aPragma: String): String;
begin
...
function TClientIDBook.GetDriverName: String;
begin
...
procedure TClientIDBook.OpenDatabase(aFileName: String);
// var
//   theCurrentMode: String;
...
procedure TClientIDBook.SetDataVersion;
begin
...
function TClientIDBook.TableExists(aTablename: String): Boolean;
begin
...
procedure TClientIDBook.UpdateEverything(aClientID: String);
var
  theTime: TDateTime;
  theNumberOfAccesses: Integer;

begin
  Assert((Length(aClientID) > 15), 'UpdateEverything had a short or blank ClientID');
...
function TClientIDBook.GetFileName: String;
begin
...
function TClientIDBook.ClientIDExists(const aClientID: String): Boolean;
var
  theClientID: String;
...
procedure TClientIDBook.FillInEverything(aClientID: String;
                                         var aTimeLastAccessed: String;
                                         var aTotalAccesses: Cardinal);
var
...
function TClientIDBook.GetDataVersion: Integer;
var
...
function TClientIDBook.NumberOfClientIDs: LongInt;
begin
...
function TClientIDBook.GetFirstClientID(var theClientID: String): Boolean;
begin
...
function TClientIDBook.GetNumberOfAccesses(aClientId: String): Cardinal;
var
...
function TClientIDBook.GetClientIDAfter(var theClientID: String): Boolean;
var
...
begin
  ...
  try
    ...
    Assert((fSQLite3Query.RecordCount = 0) or (fSQLite3Query.RecordCount = 1),
           'TClientIDBook.GetClientIDAfter() has an invalid RecordCount of ' + IntToStr(fSQLite3Query.RecordCount));
