...
begin
  ...
  RequestsMemo.Lines.Add('Taurus IO handler version: ' + TaurusTLSServerIOHandler.Version);
...
procedure TMainForm.IdHTTPServerStatus(ASender: TObject;
  const AStatus: TIdStatus; const AStatusText: string);
begin
  RequestsMemo.Lines.Add('ServerStatus - ' + AStatusText);
end;
...
begin
  RequestsMemo.Lines.Add('TaurusTLS VerifyCallback called ');
end;
