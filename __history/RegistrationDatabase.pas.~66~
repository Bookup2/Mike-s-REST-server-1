...
begin
  ...
  try
    ...
    // If the database does not have this email address, exit with blank information.
...
begin
  ...
  NumberOfRegistrations := fSQLite3Query.FieldByName(kSQLFieldCountResult).AsInteger;
end;
